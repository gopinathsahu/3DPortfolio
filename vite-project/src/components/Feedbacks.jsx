...
const FeedbackCard = ({ index, testimonial, name, designation, company, image }) => (
  <motion.div
    ...
    className="bg-black-200 p-6 rounded-3xl xs:w-[320px] w-full shadow-md" // Added shadow for visual depth
  >
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap justify-center gap-5`}> {/* Centered layout */}
